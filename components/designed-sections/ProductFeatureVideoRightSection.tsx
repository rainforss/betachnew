...
interface IProductFeatureVideoRightSectionProps {
  dynamicsPageSection?: DynamicsPageSection;
}

const ProductFeatureVideoRightSection: React.FunctionComponent<
  IProductFeatureVideoRightSectionProps
> = ({ dynamicsPageSection }) => {
...
export default ProductFeatureVideoRightSection;
