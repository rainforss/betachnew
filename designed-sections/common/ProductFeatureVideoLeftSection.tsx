...
interface IProductFeatureVideoLeftSectionProps {
  dynamicsPageSection?: DynamicsPageSection;
}

const ProductFeatureVideoLeftSection: React.FunctionComponent<
  IProductFeatureVideoLeftSectionProps
> = ({ dynamicsPageSection }) => {
...
export default ProductFeatureVideoLeftSection;
